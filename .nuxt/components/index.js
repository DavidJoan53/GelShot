...
export { default as PruebasDos } from '../../components/PruebasDos.vue'
...
export const LazyPruebasDos = import('../../components/PruebasDos.vue' /* webpackChunkName: "components/PruebasDos" */).then(c => c.default || c)
